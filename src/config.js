...
export const config = {
  ...
  mcpExecIoHeavyCapacity: parseInteger(process.env.MCP_EXEC_IO_HEAVY_CAPACITY, 2),
  mcpExecIoHeavyWeight: parseInteger(process.env.MCP_EXEC_IO_HEAVY_WEIGHT, 2),
  mcpBackgroundPriorityAgeMs: parseInteger(process.env.MCP_BACKGROUND_PRIORITY_AGE_MS, 30_000),
  ...
  mcpOauthMaxClients: parseInteger(process.env.MCP_OAUTH_MAX_CLIENTS, 256),
