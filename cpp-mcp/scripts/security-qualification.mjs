...
if(mode==='windows-asan-analysis') {
  ...
  targets=['devbox-core-tests','devbox-process-tests','devbox-storage-tests','devbox-security-tests','devbox-provider-tests','devbox-web-offer-tests','devbox-state-read-reuse-tests','devbox-state-read-bench','devbox-local-http-reuse-tests','devbox-ipc-read-bench'];
  pattern='^(core|process|storage|security|providers|web-offers|state-read-reuse|state-read-benchmark-smoke|local-http-reuse|ipc-read-benchmark-smoke)$';
  ...
  targets=['devbox-async-tests','devbox-security-tests','devbox-state-coordinator-tests','devbox-scheduler-notification-tests','devbox-state-read-reuse-tests','devbox-state-read-bench','devbox-local-http-reuse-tests','devbox-ipc-read-bench'];
  pattern='^(async|security|state-coordinator|scheduler-notifications|state-read-reuse|state-read-benchmark-smoke|local-http-reuse|ipc-read-benchmark-smoke)$';
} else {
